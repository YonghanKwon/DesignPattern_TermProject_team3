...
public class HTMLExporterTest {
    ...
    public void HTML() throws IOException {
        ...
        out.close();
        File file = new File("c:/dp2023/people.html");
...
//        HTMLExporter테스트
        ...
        Writer out1 = new FileWriter("c:/dp2023/bloodstorage.html");
        HTMLExporter builder2 = new HTMLExporter(out1);
        bloodstorage.export(builder2);
        out1.close();
        File file2 = new File("c:/dp2023/bloodstorage.html");
...
//        HTMLExporter테스트
        ...
        Writer out2 = new FileWriter("c:/dp2023/movie.html");
        HTMLExporter builder3 = new HTMLExporter(out2);
        movie.export(builder3);
        out2.close();
        File file3 = new File("c:/dp2023/movie.html");
